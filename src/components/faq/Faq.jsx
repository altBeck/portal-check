...
const Faq = () => {
  return (
    <div className="px-4 relative max-w-6xl mx-auto pt-4 pb-16 md:py-32">
      <div className="pb-10 pt-8 xl:pt-0 sm:text-center">
      ...
      <div>
        <div className="max-w-xl mx-auto">
          <h1 className="text-2xl md:text-5xl sm:text-center font-semibold py-4">What is Portal Check?</h1>
          <p className="text-[#666] sm:text-center mb-4">
            <span>
        ...
        <h1 className="py-4 text-2xl md:text-5xl sm:text-center font-semibold">Who is Portal Check for?</h1>
        <QnA />
      </div>
    </div>
  )
